...
const localCategories = [
  { name: 'Antolini', media: '/brands/b1.png' },
  { name: 'Atlas', media: '/brands/b2.png' },
  { name: 'Cambria', media: '/brands/b3.png' },
  { name: 'CeasarStone', media: '/brands/b4.png' },
  { name: 'Compac', media: '/brands/b5.png' },
  { name: 'Dekton', media: '/brands/b6.png' },
  { name: 'Hanstone', media: '/brands/b8.png' },
  { name: 'Viatera', media: '/brands/b9.png' },
  { name: 'Mikado', media: '/brands/b10.png' },
  { name: 'Silestone', media: '/brands/b14.png' },
];
